...
public class GameView extends View {
    ...
    public void setupPuzzle(Bitmap source) {
    ...
    private void finishGame(String msg) {
        ...
        long totalSeconds =(timerActive ? (System.currentTimeMillis() - beginTime) / 1000 : 0);
        Toast.makeText(
                getContext(),
    ...
    private void verifySolution() {
        ...
        if(completed){
            ...
            finishGame("拼图完成! 总交换次数: " + moveCounter + ", 用时: " + totalTime + "秒");
        }
    }
